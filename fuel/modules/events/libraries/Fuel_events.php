...
class Fuel_events extends Fuel_advanced_module {

	public $name = "events"; // the folder name of the module
	 ...
	 * You will be able to access it via $this->fuel->events->my_method()
	 */
}