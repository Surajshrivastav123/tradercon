...
class Event_images_model extends Base_module_model {

	// read more about models in the user guide to get a list of all properties. Below is a subset of the most common:

	public $record_class = 'Event_image'; // the name of the record class (if it can't be determined)
	...
	{
		parent::__construct('fuel_event_images'); // table name
	}

	public function list_items($limit = NULL, $offset = NULL, $col = 'precedence', $order = 'asc', $just_count = FALSE)
	{
		// $this->db->select('event_images.id, event_images.title, event_images.published....'); uncomment and  change to the fields to be displayed
...
class Event_image_model extends Base_module_record {
