...
class Events_master_model extends Base_module_model {

	// read more about models in the user guide to get a list of all properties. Below is a subset of the most common:

	public $record_class = 'Events_master_item'; // the name of the record class (if it can't be determined)
	...
	{
		parent::__construct('fuel_events_master'); // table name
	}

	public function list_items($limit = NULL, $offset = NULL, $col = 'precedence', $order = 'asc', $just_count = FALSE)
	{
		  $this->db->select('id, title, content, start_date, precedence, end_date,published');
	...
	{	
		...
		$fields['sponsors_banner']= array('required'=>'required',  'label' => 'sponsors banner','type' => 'asset','display_preview' => TRUE,'hide_options' => TRUE,'encrypt_name' => TRUE,
...
class Events_master_item_model extends Base_module_record {
