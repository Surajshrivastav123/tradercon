...
class Sponsors_master_model extends Base_module_model {

	// read more about models in the user guide to get a list of all properties. Below is a subset of the most common:

	public $record_class = 'Sponsors_master_item'; // the name of the record class (if it can't be determined)
	...
	{
		parent::__construct('fuel_sponsors_master'); // table name
	}

	public function list_items($limit = NULL, $offset = NULL, $col = 'precedence', $order = 'asc', $just_count = FALSE)
	{
		// $this->db->select('sponsors_master.id, sponsors_master.title, sponsors_master.published....'); uncomment and  change to the fields to be displayed
	...
	{	
		...
		'is_image' => TRUE,'display_overwrite' => FALSE);
		return $fields;
	}
...
class Sponsors_master_item_model extends Base_module_record {
