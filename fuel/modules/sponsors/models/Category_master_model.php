...
class Category_master_model extends Base_module_model {

	// read more about models in the user guide to get a list of all properties. Below is a subset of the most common:

	public $record_class = 'Category_master_item'; // the name of the record class (if it can't be determined)
	...
	{
		parent::__construct('fuel_category_master'); // table name
	}

	public function list_items($limit = NULL, $offset = NULL, $col = 'precedence', $order = 'asc', $just_count = FALSE)
	{
		// $this->db->select('category_master.id, category_master.title, category_master.published....'); uncomment and  change to the fields to be displayed
...
class Category_master_item_model extends Base_module_record {
