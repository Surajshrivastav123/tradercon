...
class Fuel_sponsors extends Fuel_advanced_module {

	public $name = "sponsors"; // the folder name of the module
	 ...
	 * You will be able to access it via $this->fuel->sponsors->my_method()
	 */
}