...
class Fuel_speakers extends Fuel_advanced_module {

	public $name = "speakers"; // the folder name of the module
	 ...
	 * You will be able to access it via $this->fuel->speakers->my_method()
	 */
}