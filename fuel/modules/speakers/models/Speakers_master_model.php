...
class Speakers_master_model extends Base_module_model {

	// read more about models in the user guide to get a list of all properties. Below is a subset of the most common:

	public $record_class = 'Speakers_master_item'; // the name of the record class (if it can't be determined)
	...
	{
		parent::__construct('fuel_speakers_master'); // table name
	}

	public function list_items($limit = NULL, $offset = NULL, $col = 'precedence', $order = 'asc', $just_count = FALSE)
	{
 $this->db->select('id, name, email, phone_number, precedence, date_added, is_active');  
...
class Speakers_master_item_model extends Base_module_record {
