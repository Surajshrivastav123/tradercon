...
class Banners_model extends Base_module_model {

	// read more about models in the user guide to get a list of all properties. Below is a subset of the most common:

	public $record_class = 'Banner'; // the name of the record class (if it can't be determined)
	...
	{
		parent::__construct('fuel_banners'); // table name
	}

	public function list_items($limit = NULL, $offset = NULL, $col = '', $order = 'asc', $just_count = FALSE)
	{
		// $this->db->select('banners.id, banners.title, banners.published....'); uncomment and  change to the fields to be displayed
	...
	{	
		...
		$fields['image']= array('required'=>'required',  'label' => 'Image','type' => 'asset','display_preview' => TRUE,'hide_options' => TRUE,'encrypt_name' => TRUE,
...
class Banner_model extends Base_module_record {
