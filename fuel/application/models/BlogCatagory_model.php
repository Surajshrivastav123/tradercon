...
class BlogCatagory_model extends Base_module_model {

	// read more about models in the user guide to get a list of all properties. Below is a subset of the most common:

	public $record_class = 'BlogCatagory_item'; // the name of the record class (if it can't be determined)
	...
	{
		parent::__construct('fuel_blogcatagory'); // table name
	}

	public function list_items($limit = NULL, $offset = NULL, $col = 'precedence', $order = 'asc', $just_count = FALSE)
	{
		// $this->db->select('BlogCatagory.id, BlogCatagory.title, BlogCatagory.published....'); uncomment and  change to the fields to be displayed
...
class BlogCatagory_item_model extends Base_module_record {
