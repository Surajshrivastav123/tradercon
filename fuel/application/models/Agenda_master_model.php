...
class Agenda_master_model extends Base_module_model {

	// read more about models in the user guide to get a list of all properties. Below is a subset of the most common:

	public $record_class = 'Agenda_master_item'; // the name of the record class (if it can't be determined)
	...
	{
		parent::__construct('fuel_agenda_master'); // table name
	}

	public function list_items($limit = NULL, $offset = NULL, $col = 'precedence', $order = 'asc', $just_count = FALSE)
	{
		// $this->db->select('agenda_master.id, agenda_master.title, agenda_master.published....'); uncomment and  change to the fields to be displayed
...
class Agenda_master_item_model extends Base_module_record {
