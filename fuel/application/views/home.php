...
<div class="react-wrapper">
  <div class="react-wrapper-inner"> 
    ...
    <style>
      .banner {
        print_r($vars['banner']);<?=img_path('banner/'.$banner->image)?>
        print_r($vars['banner']);
      background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('<?=img_path('banner/'.$banner->image)?>');
      }
</style>
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="about__content">
              ...
              <p class="about__paragraph">It all began on a cold winter morning on 26th October 2012 at Bangalore. History was made with the successful launch of the very first Edition of Traders Convention.</p>
  ...
  <div class="pricing-section home-five pt---120">
    ...
    <div class="container">
      <div class="section-title-area home-five text-center">
        <div class="section-pretitle">We Are Offer 3 Unique Pricing Plans</div>
