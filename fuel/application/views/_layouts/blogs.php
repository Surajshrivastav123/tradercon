...
<div class="react-wrapper-inner"> 
  ...
  <div class="react-breadcrumbs">
    <div class="breadcrumbs-wrap"> <img class="desktop" src="assets/images/breadcrumbs/1.jpg" alt="Breadcrumbs"> <img class="mobile" src="assets/images/breadcrumbs/1.jpg" alt="Breadcrumbs">
          ...
          <?php foreach($bloglist as $blog){ ?>
            <div class="single-blog">
              <div class="inner-blog">
                <div class="blog-img"> <img src="<?=img_path("blog/".$blog->image)?>" alt="Blog Image"></div>
                <div class="blog-content">
                  <ul class="top-part">
                    <li> <img src="<?=img_path("blog/author1.png")?>" alt="user"><?=$blog->author?></li>
                    <li class="date-part">
                      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-clock">
                        <circle cx="12" cy="12" r="10"></circle>
                        <polyline points="12 6 12 12 16 14"></polyline>
                      </svg>
                      <?=date("M d,Y",strtotime($blog->publish_date))?> </li>
                  </ul>
                  <h3 class="blog-title"><a href="<?=base_url('blog/'.$blog->slug)?>"><?=$blog->title?></a></h3>
                  <p class="blog-desc"><?=substr($blog->content,50)?> </p>
                  <div class="button__sec"> <a href="<?=base_url('blog/'.$blog->slug)?>" class="blog-btn">Read More
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-arrow-right">
                      <line x1="5" y1="12" x2="19" y2="12"></line>
                      <polyline points="12 5 19 12 12 19"></polyline>
                    </svg>
                    </a>
                    <div class="share-course"> Post Share <em>
        ...
        <div class="col-lg-4">
          <div class="react-sidebar ml----30">
            ...
            <div class="widget back-post">
              <h3 class="widget-title">Related Videos</h3>
